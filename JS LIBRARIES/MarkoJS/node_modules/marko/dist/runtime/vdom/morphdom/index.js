...
var virtualizeElement = VElement.bN_;
var morphAttrs = VElement.bO_;
...
function morphdom(fromNode, toNode, doc, componentsContext) {
  ...
  parentComponent)
  {
    ...
    if (
    vNode.bB_ === ELEMENT_NODE ||
    vNode.bB_ === FRAGMENT_NODE)
    {
      if (key) {
        ...
        if (curFromNodeKey === curToNodeKey) {
          ...
          matchingFromEl === curFromNodeChild)
          {
            if (isHydrate === true && curFromNodeChild) {
              ...
              curToNodeChild.bB_ === FRAGMENT_NODE &&
            ...
            if (!curToNodeChild.n_) {
              ...
              if (compareNodeNames(curVFromNodeChild, curToNodeChild)) {
                if (fromNextSibling === matchingFromEl) {
                  ...
                  if (
                  toNextSibling &&
                  toNextSibling.bA_ === curFromNodeKey)
                  {
                    // Single element swap
      ...
      while (curFromNodeChild) {
        ...
        if (curFromNodeType === curToNodeType) {
          ...
          curFromNodeType === COMMENT_NODE)
          {
            ...
            toNextSibling &&
            curFromNodeType === TEXT_NODE &&
            toNextSibling.bB_ === TEXT_NODE)
            {
              fromNextSibling = curFromNodeChild.splitText(
              curToNodeChild.bU_.length);
  ...
  function morphEl(fromEl, vFromEl, toEl, parentComponent) {
    ...
    if (constId !== undefined && vFromEl.bJ_ === constId) {
      return;
    }
